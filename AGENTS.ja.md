...
- 英語版だけを正本として扱い、`.ja.*` を先に変更したり独立して更新したりしない
- 英語正本を変更したときは、対応する `.ja.*` を全文再翻訳で作り直し、日本語版全体を現行の英語内容に一致させる
...
- 公開 API、CLI の表面、コマンドラインオプション、watch 名、環境変数など user-facing な挙動を変えたときは、`README.md` と重要な利用者向け文書の更新要否を必ず確認する
